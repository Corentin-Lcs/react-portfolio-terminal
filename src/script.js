    ...
    if (cmd === 'help') {
      ...
      return this.setState(state => ({
        fieldHistory: [...state.fieldHistory, {text: [
          ...
          `I would like to become an artificial intelligence or cybersecurity engineer.`,
          `\n`,
      ...
      return this.setState(state => ({
        fieldHistory: [...state.fieldHistory, {text: [
          'IUT de Paris - Rives de Seine......................2022-2025',
          'Forensic Analyst...................................2019-Present',
          'Lycée Polyvalent Jean-Baptiste Dumas...............2019-2022',
          'Project lead developer.............................2018-2018',
          'Solo Trumpet in the Nîmes Symphony Orchestra.......2017-2022'],
          hasBuffer: true}]}));
      ...
      return this.setState(state => ({
        fieldHistory: [...state.fieldHistory, {text: [
          'LinkedIn: Corentin Lenclos',
          'GitHub: @Corentin-Lcs',
          'Twitter: @CorentinLenclos',
        ],
